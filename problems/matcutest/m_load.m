function problem = m_load(problem_name)
%M_LOAD coverts a problem in MatCUTEst to a Problem class instance.
%
%   Users only need to use the following signature to call this function:
%
%   PROBLEM = M_LOAD(PROBLEM_NAME) returns a Problem class instance PROBLEM
%   that corresponds to the problem named PROBLEM_NAME in MatCUTEst.
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    try
        ...
        error("MATLAB:m_load:errormacup", "Error occurred while using macup function on problem %s. Please check if MatCUTEst is installed correctly.", problem_name);
    end
