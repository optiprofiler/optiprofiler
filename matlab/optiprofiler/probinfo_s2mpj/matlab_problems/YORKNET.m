...
switch(action)
    ...
    case {'setup','setup_redprec'}
        ...
        for I=v_('ONE'):v_('NSTEP')
            ...
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['qr',int2str(round(v_('1'))),',',int2str(I)]);
            valA(end+1) = -1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['qs',int2str(round(v_('1'))),',',int2str(I)]);
            valA(end+1) = -1.0;
            [ig,ig_] = s2mpjlib('ii',['ND',int2str(round(v_('1'))),',',int2str(I)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['ND',int2str(round(v_('1'))),',',int2str(I)];
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('13'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            [ig,ig_] = s2mpjlib('ii',['ND',int2str(round(v_('2'))),',',int2str(I)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['ND',int2str(round(v_('2'))),',',int2str(I)];
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['qr',int2str(round(v_('2'))),',',int2str(I)]);
            valA(end+1) = -1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['qs',int2str(round(v_('2'))),',',int2str(I)]);
            valA(end+1) = -1.0;
            [ig,ig_] = s2mpjlib('ii',['ND',int2str(round(v_('2'))),',',int2str(I)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['ND',int2str(round(v_('2'))),',',int2str(I)];
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('14'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('15'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            [ig,ig_] = s2mpjlib('ii',['ND',int2str(round(v_('3'))),',',int2str(I)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['ND',int2str(round(v_('3'))),',',int2str(I)];
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['qr',int2str(round(v_('3'))),',',int2str(I)]);
            valA(end+1) = -1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('5'))),',',int2str(I)]);
            valA(end+1) = -1.0;
            [ig,ig_] = s2mpjlib('ii',['ND',int2str(round(v_('3'))),',',int2str(I)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['ND',int2str(round(v_('3'))),',',int2str(I)];
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('6'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            [ig,ig_] = s2mpjlib('ii',['ND',int2str(round(v_('4'))),',',int2str(I)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['ND',int2str(round(v_('4'))),',',int2str(I)];
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['qr',int2str(round(v_('4'))),',',int2str(I)]);
            valA(end+1) = -1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('12'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            [ig,ig_] = s2mpjlib('ii',['ND',int2str(round(v_('4'))),',',int2str(I)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['ND',int2str(round(v_('4'))),',',int2str(I)];
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('8'))),',',int2str(I)]);
            valA(end+1) = -1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('9'))),',',int2str(I)]);
            valA(end+1) = -1.0;
            ...
            valA(end+1) = -1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('1'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            [ig,ig_] = s2mpjlib('ii',['ND',int2str(round(v_('6'))),',',int2str(I)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['ND',int2str(round(v_('6'))),',',int2str(I)];
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('2'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('3'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            [ig,ig_] = s2mpjlib('ii',['ND',int2str(round(v_('6'))),',',int2str(I)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['ND',int2str(round(v_('6'))),',',int2str(I)];
            ...
            valA(end+1) = -1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('7'))),',',int2str(I)]);
            valA(end+1) = -1.0;
            [ig,ig_] = s2mpjlib('ii',['ND',int2str(round(v_('7'))),',',int2str(I)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['ND',int2str(round(v_('7'))),',',int2str(I)];
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('11'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            ...
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('4'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('5'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            ...
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('10'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['q',int2str(round(v_('14'))),',',int2str(I)]);
            valA(end+1) = -1.0;
        ...
        for I=v_('1'):v_('NSTEP')
            ...
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['h',int2str(round(v_('13'))),',',int2str(I)]);
            valA(end+1) = -1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['h',int2str(round(v_('5'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            [ig,ig_] = s2mpjlib('ii',['EL',int2str(round(v_('2'))),',',int2str(I)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['EL',int2str(round(v_('2'))),',',int2str(I)];
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['h',int2str(round(v_('7'))),',',int2str(I)]);
            valA(end+1) = -1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['h',int2str(round(v_('6'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            [ig,ig_] = s2mpjlib('ii',['EL',int2str(round(v_('3'))),',',int2str(I)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['EL',int2str(round(v_('3'))),',',int2str(I)];
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['h',int2str(round(v_('8'))),',',int2str(I)]);
            valA(end+1) = -1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['h',int2str(round(v_('6'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            ...
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['h',int2str(round(v_('10'))),',',int2str(I)]);
            valA(end+1) = -1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['h',int2str(round(v_('9'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            [ig,ig_] = s2mpjlib('ii',['EL',int2str(round(v_('5'))),',',int2str(I)],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['EL',int2str(round(v_('5'))),',',int2str(I)];
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['h',int2str(round(v_('3'))),',',int2str(I)]);
            valA(end+1) = -1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['h',int2str(round(v_('9'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            ...
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['h',int2str(round(v_('4'))),',',int2str(I)]);
            valA(end+1) = -1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['h',int2str(round(v_('12'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            ...
            valA(end+1) = -1.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['h',int2str(round(v_('11'))),',',int2str(I)]);
            valA(end+1) = 1.0;
            for J=v_('SuPMP'):v_('EuPMP')
        ...
        for I=v_('ONE'):v_('NSTEP')
            for J=v_('SuTW'):v_('EuTW')
                ...
                gtype{ig} = '<>';
                irA(end+1)  = ig;
                icA(end+1)  = ix_(['qs',int2str(J),',',int2str(I)]);
                valA(end+1) = v_(['CTW',int2str(J),',',int2str(I)]);
            end
            for J=v_('SuPMP'):v_('EuPMP')
        ...
        for J=v_('SuRES'):v_('EuRES')
            ...
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['h',int2str(J),',',int2str(round(v_('1')))]);
            valA(end+1) = v_(['MXAR',int2str(J)]);
            [ig,ig_] = s2mpjlib('ii',['RD',int2str(J),',',int2str(round(v_('1')))],ig_);
            gtype{ig}  = '==';
            cnames{ig} = ['RD',int2str(J),',',int2str(round(v_('1')))];
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['qr',int2str(J),',',int2str(round(v_('1')))]);
            valA(end+1) = v_(['MST',int2str(round(v_('1')))]);
        end
        for I=v_('2'):v_('NSTEP')
            for J=v_('SuRES'):v_('EuRES')
                v_('A') = -1+I;
                ...
                irA(end+1)  = ig;
                icA(end+1)  = ix_(['h',int2str(J),',',int2str(I)]);
                valA(end+1) = v_(['MXAR',int2str(J)]);
                irA(end+1)  = ig;
                icA(end+1)  = ix_(['h',int2str(J),',',int2str(round(v_('A')))]);
                valA(end+1) = v_(['XAR',int2str(J)]);
                irA(end+1)  = ig;
                icA(end+1)  = ix_(['qr',int2str(J),',',int2str(I)]);
                valA(end+1) = v_(['MST',int2str(I)]);
            end
        end
        %%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        pb.n   = ix_.Count;
