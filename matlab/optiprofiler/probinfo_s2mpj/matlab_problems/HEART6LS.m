...
switch(action)
    ...
    case {'setup','setup_redprec'}
        ...
        pbm.gconst(ig_('G1')) = v_('sumuA');
        pbm.gconst(ig_('G2')) = v_('sumuB');
        pbm.gconst(ig_('G3')) = v_('sumuC');
        pbm.gconst(ig_('G4')) = v_('sumuD');
        pbm.gconst(ig_('G5')) = v_('sumuE');
        pbm.gconst(ig_('G6')) = v_('sumuF');
        %%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        posev = find(strcmp('Y',elftv{ielftype(ie)}));
        pbm.elvar{ie}(posev) = iv;
        [~,posep] = ismember('ALPHA',elftp{ielftype(ie)});
        pbm.elpar{ie}(posep) = v_('sumuMx');
        ename = 'E3';
        [ie,ie_] = s2mpjlib('ii',ename,ie_);
        pbm.elftype{ie} = 'en2PROD';
        ielftype(ie) = iet_('en2PROD');
        ...
        ename = 'E11';
        [ie,ie_] = s2mpjlib('ii',ename,ie_);
        pbm.elftype{ie} = 'ePDFSQ';
        ielftype(ie) = iet_('ePDFSQ');
        vname = 'a';
        [iv,ix_,pb] = s2mpjlib('nlx',vname,ix_,pb,1,[],[],1.0);
        posev = find(strcmp('X',elftv{ielftype(ie)}));
        pbm.elvar{ie}(posev) = iv;
        ...
        ename = 'E12';
        [ie,ie_] = s2mpjlib('ii',ename,ie_);
        pbm.elftype{ie} = 'eP3PRD';
        ielftype(ie) = iet_('eP3PRD');
        vname = 'c';
        [iv,ix_,pb] = s2mpjlib('nlx',vname,ix_,pb,1,[],[],1.0);
        posev = find(strcmp('X',elftv{ielftype(ie)}));
        pbm.elvar{ie}(posev) = iv;
        ...
        ename = 'E19';
        [ie,ie_] = s2mpjlib('ii',ename,ie_);
        pbm.elftype{ie} = 'eD3PRD';
        ielftype(ie) = iet_('eD3PRD');
        vname = 'a';
        [iv,ix_,pb] = s2mpjlib('nlx',vname,ix_,pb,1,[],[],1.0);
        posev = find(strcmp('X',elftv{ielftype(ie)}));
        pbm.elvar{ie}(posev) = iv;
