...
switch(action)
    ...
    case {'setup','setup_redprec'}
        ...
        pb.xupper(ix_('c0'),1) = +Inf;
        pb.xlower(ix_('c1')) = -Inf;
        pb.xupper(ix_('c1'),1) = +Inf;
        pb.xlower(ix_('c2')) = -Inf;
        pb.xupper(ix_('c2'),1) = +Inf;
        pb.xlower(ix_('c3')) = -Inf;
        pb.xupper(ix_('c3'),1) = +Inf;
        pb.xlower(ix_('d0')) = -Inf;
        pb.xupper(ix_('d0'),1) = +Inf;
        pb.xlower(ix_('d1')) = -Inf;
        pb.xupper(ix_('d1'),1) = +Inf;
        pb.xlower(ix_('d2')) = -Inf;
        pb.xupper(ix_('d2'),1) = +Inf;
        pb.xlower(ix_('d3')) = -Inf;
        pb.xupper(ix_('d3'),1) = +Inf;
        %%%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
