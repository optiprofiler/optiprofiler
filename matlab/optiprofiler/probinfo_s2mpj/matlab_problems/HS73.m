...
switch(action)
    ...
    case {'setup','setup_redprec'}
        ...
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = 24.55+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = 24.55;
        end
        iv = ix_('X2');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = 26.75+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = 26.75;
        end
        iv = ix_('X3');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = 39.0+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = 39.0;
        end
        iv = ix_('X4');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = 40.50+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = 40.50;
        end
        ...
        iv = ix_('X2');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = 11.9+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = 11.9;
        end
        iv = ix_('X3');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = 41.8+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = 41.8;
        end
        iv = ix_('X4');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = 52.1+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = 52.1;
        end
