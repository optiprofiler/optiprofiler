function varargout = CERI651D(action,varargin)
...
switch(action)
    ...
    pbm.name     = 'CERI651D';
        ...
        if(isKey(ix_,'I'))
            ...
            pb.y0(find(pbm.congrps==ig_('I')),1) = 15.1595;
        end
        if(isKey(ix_,'S'))
            pb.x0(ix_('S'),1) = 8.0;
        else
        ...
        if(isKey(ix_,'X0'))
            ...
            pb.y0(find(pbm.congrps==ig_('X0')),1) = 13072.9;
        end
        %%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
