...
% IE N                   100000         $-PARAMETER n = 1000010, m = 700000
        ...
        for T=v_('1'):v_('N')
            ...
            for I=v_('1'):v_('7')
                ...
                irA(end+1)  = ig;
                icA(end+1)  = ix_(['X',int2str(I),',',int2str(T)]);
                valA(end+1) = -1.0;
                irA(end+1)  = ig;
                icA(end+1)  = ix_(['X',int2str(I),',',int2str(round(v_('T-1')))]);
                valA(end+1) = 1.0;
            end
