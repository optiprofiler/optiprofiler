function varargout = SPARSQUR(action,varargin)
...
switch(action)
    ...
    case {'setup','setup_redprec'}
        ...
        [it,iet_] = s2mpjlib( 'ii', 'eSQUR',iet_);
        elftv{it}{1} = 'X';
        %%%%%%%%%%%%%%%%%%% ELEMENT USES %%%%%%%%%%%%%%%%%%
        ...
        for I=v_('1'):v_('N')
            ...
            pbm.elftype{ie} = 'eSQUR';
            ielftype(ie) = iet_('eSQUR');
            vname = ['X',int2str(I)];
...
% **********************
    ...
    case 'gSQR'
        ...
        GVAR_ = varargin{1};
        igr_  = varargin{2};
        varargout{1} = 0.5e0*pbm.grpar{igr_}(1)*GVAR_*GVAR_;
        if(nargout>1)
