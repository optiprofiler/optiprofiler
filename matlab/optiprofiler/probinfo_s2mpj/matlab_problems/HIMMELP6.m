function varargout = HIMMELP6(action,varargin)
...
switch(action)
    ...
    case {'setup','setup_redprec'}
        ...
        pbm.gconst(ig_('C5')) = 700.0;
        pbm.gconst(ig_('C9')) = 2775.0;
        pbm.gconst(ig_('C11')) = 22.5;
        pbm.gconst(ig_('C12')) = 41.4;
        %%%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
