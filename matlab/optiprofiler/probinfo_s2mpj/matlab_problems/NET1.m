...
switch(action)
    ...
    case {'setup','setup_redprec'}
        ...
        irA(end+1)  = ig;
        icA(end+1)  = ix_('NOP3');
        valA(end+1) = 1.00000000;
        irA(end+1)  = ig;
        icA(end+1)  = ix_('NOP2');
        valA(end+1) = -1.40000000;
        irA(end+1)  = ig;
        icA(end+1)  = ix_('CBV18');
        valA(end+1) = 0.00000;
