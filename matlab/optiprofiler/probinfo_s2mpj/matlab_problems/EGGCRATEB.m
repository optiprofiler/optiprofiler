function varargout = EGGCRATEB(action,varargin)
...
switch(action)
    ...
    case {'setup','setup_redprec'}
        ...
        vname = 'X';
        [iv,ix_,pb] = s2mpjlib('nlx',vname,ix_,pb,1,-5.0,5.0,[]);
