function varargout = CERI651C(action,varargin)
...
switch(action)
    ...
    pbm.name     = 'CERI651C';
        ...
        if(isKey(ix_,'I'))
            ...
            pb.y0(find(pbm.congrps==ig_('I')),1) = 597.076;
        end
        if(isKey(ix_,'S'))
            pb.x0(ix_('S'),1) = 22.9096;
        else
            pb.y0(find(pbm.congrps==ig_('S')),1) = 22.9096;
        end
        if(isKey(ix_,'X0'))
            pb.x0(ix_('X0'),1) = 24027.5;
        else
            pb.y0(find(pbm.congrps==ig_('X0')),1) = 24027.5;
        end
        %%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
