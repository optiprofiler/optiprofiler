function varargout = CERI651B(action,varargin)
...
switch(action)
    ...
    pbm.name     = 'CERI651B';
        ...
        if(isKey(ix_,'I'))
            ...
            pb.y0(find(pbm.congrps==ig_('I')),1) = 3527.31;
        end
        if(isKey(ix_,'S'))
            pb.x0(ix_('S'),1) = 29.4219;
        else
            pb.y0(find(pbm.congrps==ig_('S')),1) = 29.4219;
        end
        if(isKey(ix_,'X0'))
            pb.x0(ix_('X0'),1) = 26185.9;
        else
            pb.y0(find(pbm.congrps==ig_('X0')),1) = 26185.9;
        end
        %%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
