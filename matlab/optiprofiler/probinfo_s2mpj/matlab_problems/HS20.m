function varargout = HS20(action,varargin)
...
switch(action)
    ...
    case {'setup','setup_redprec'}
        ...
        pb.xlower(ix_('X1'),1) = -0.5;
        pb.xupper(ix_('X1')) = 0.5;
        pb.xlower(ix_('X2')) = -Inf;
        pb.xupper(ix_('X2'),1) = +Inf;
        %%%%%%%%%%%%%%%%%%%% START POINT %%%%%%%%%%%%%%%%%%
