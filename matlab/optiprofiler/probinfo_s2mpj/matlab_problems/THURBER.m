function varargout = THURBER(action,varargin)
...
switch(action)
    ...
    case {'setup','setup_redprec'}
        ...
        if(isKey(ix_,'B1'))
            ...
            pb.y0(find(pbm.congrps==ig_('B1')),1) = 1000.0;
        end
        if(isKey(ix_,'B2'))
            pb.x0(ix_('B2'),1) = 1000.0;
        else
            pb.y0(find(pbm.congrps==ig_('B2')),1) = 1000.0;
        end
        if(isKey(ix_,'B3'))
            pb.x0(ix_('B3'),1) = 400.0;
        else
            pb.y0(find(pbm.congrps==ig_('B3')),1) = 400.0;
        end
        if(isKey(ix_,'B4'))
            pb.x0(ix_('B4'),1) = 40.0;
        else
        ...
        if(isKey(ix_,'B6'))
            ...
            pb.y0(find(pbm.congrps==ig_('B6')),1) = 0.3;
        end
        if(isKey(ix_,'B7'))
            pb.x0(ix_('B7'),1) = 0.03;
        else
            pb.y0(find(pbm.congrps==ig_('B7')),1) = 0.03;
        end
        %%%%%%%%%%%%%%%%%%%%% ELFTYPE %%%%%%%%%%%%%%%%%%%%%
