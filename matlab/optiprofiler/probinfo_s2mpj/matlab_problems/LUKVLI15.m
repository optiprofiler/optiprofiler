function varargout = LUKVLI15(action,varargin)
...
%    *********
% 
%    Source: Problem 5.15, the chained modified HS50 problem, 
...
% IE N                   99997          $-PARAMETER
        ...
        for K=v_('1'):v_('3'):v_('NC')
            ...
            valA(end+1) = 2.0;
            irA(end+1)  = ig;
            icA(end+1)  = ix_(['X',int2str(round(v_('K+4')))]);
            valA(end+1) = 3.0;
        end
        %%%%%%%%%%%%%%% GLOBAL DIMENSIONS %%%%%%%%%%%%%%%%%
        pb.n   = ix_.Count;
        ...
        for K=v_('1'):v_('NC')
            pbm.gconst(ig_(['C',int2str(K)])) = 6.0;
        end
        %%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        for I=v_('1'):v_('4'):v_('N')
            pb.x0(ix_(['X',int2str(I)]),1) = 35.0;
        end
        for I=v_('2'):v_('4'):v_('N')
            pb.x0(ix_(['X',int2str(I)]),1) = 11.0;
        end
