function varargout = ZECEVIC3(action,varargin)
...
switch(action)
    ...
    case {'setup','setup_redprec'}
        ...
        pbm.gconst(ig_('OBJ')) = -300.0;
        pbm.gconst(ig_('CON1')) = -1.0;
        pbm.gconst(ig_('CON2')) = 9.0;
        %%%%%%%%%%%%%%%%%%%%  BOUNDS %%%%%%%%%%%%%%%%%%%%%
        ...
        ig = ig_('CON2');
        posel = length(pbm.grelt{ig})+1;
        pbm.grelt{ig}(posel) = ie_('CON21');
        nlc = union(nlc,ig);
        pbm.grelw{ig}(posel) = 1.0;
        posel = posel+1;
        pbm.grelt{ig}(posel) = ie_('CON22');
        pbm.grelw{ig}(posel) = 1.0;
        %%%%%%%%%%%%%%%%%%% OBJECT BOUNDS %%%%%%%%%%%%%%%%%
%    Solution
% LO SOLTN                -97.30952
