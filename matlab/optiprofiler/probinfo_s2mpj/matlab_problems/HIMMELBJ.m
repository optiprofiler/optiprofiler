...
switch(action)
    ...
    case {'setup','setup_redprec'}
        ...
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = -7.69+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = -7.69;
        end
        iv = ix_('X3,1');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = -11.52+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = -11.52;
        end
        iv = ix_('X4,1');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = -36.60+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = -36.60;
        end
        iv = ix_('X1,2');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = -10.94+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = -10.94;
        end
        iv = ix_('X8,2');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = 2.5966+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = 2.5966;
        end
        iv = ix_('X9,2');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = -39.39+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = -39.39;
        end
        iv = ix_('X10,2');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = -21.35+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = -21.35;
        end
        iv = ix_('X11,2');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = -32.84+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = -32.84;
        end
        iv = ix_('X12,2');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = 6.26+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = 6.26;
        end
        iv = ix_('X1,3');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = 10.45+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = 10.45;
        end
        iv = ix_('X3,3');
        ...
        iv = ix_('X7,3');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = 2.2435+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = 2.2435;
        end
        iv = ix_('X9,3');
        ...
        iv = ix_('X12,3');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = 6.12+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = 6.12;
        end
        iv = ix_('X15,3');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = -1.9028+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = -1.9028;
        end
        iv = ix_('X16,3');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = -2.8889+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = -2.8889;
        end
        iv = ix_('X17,3');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = -3.3622+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = -3.3622;
        end
        iv = ix_('X18,3');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = -7.4854+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = -7.4854;
        end
        iv = ix_('X1,4');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = -15.639+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = -15.639;
        end
        iv = ix_('X3,4');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = 21.81+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = 21.81;
        end
        iv = ix_('X1,5');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = -16.79+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = -16.79;
        end
        iv = ix_('X3,5');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = 18.9779+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = 18.9779;
        end
        iv = ix_('X2,6');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = 11.959+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = 11.959;
        end
        iv = ix_('X2,7');
        if(size(pbm.A,1)>=ig&&size(pbm.A,2)>=iv)
            pbm.A(ig,iv) = 12.899+pbm.A(ig,iv);
        else
            pbm.A(ig,iv) = 12.899;
        end
