classdef TestFeatureOptionKey < matlab.unittest.TestCase
    methods (Test)
        ...
        function testEnumerationValues(testCase)
            ...
            expectedValues = {'N_RUNS'; 'DISTRIBUTION'; 'NOISE_LEVEL'; 'NOISE_TYPE'; 'SIGNIFICANT_DIGITS'; 'PERTURBED_TRAILING_ZEROS'; 'ROTATED'; 'CONDITION_FACTOR'; 'NAN_RATE'; 'UNRELAXABLE_BOUNDS'; 'UNRELAXABLE_LINEAR_CONSTRAINTS'; 'UNRELAXABLE_NONLINEAR_CONSTRAINTS'; 'MESH_SIZE'; 'GROUND_TRUTH'; 'MOD_X0'; 'MOD_AFFINE'; 'MOD_BOUNDS'; 'MOD_LINEAR_UB'; 'MOD_LINEAR_EQ'; 'MOD_FUN'; 'MOD_CUB'; 'MOD_CEQ'};
