classdef TestProfileOptionKey < matlab.unittest.TestCase
    methods (Test)
        ...
        function testConstructor(testCase)
            ...
            testCase.verifyEqual(ProfileOptionKey.DRAW_HIST_PLOTS.value, 'draw_hist_plots');
            ...
            testCase.verifyEqual(ProfileOptionKey.SCORE_FUN.value, 'score_fun');
            testCase.verifyEqual(ProfileOptionKey.LOAD.value, 'load');
            testCase.verifyEqual(ProfileOptionKey.SOLVERS_TO_LOAD.value, 'solvers_to_load');
