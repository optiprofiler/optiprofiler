...
'time_stamp_20250507_212310.txt': file, recording the time stamp of the current experiment.
'profile_figs': folder, containing all the FIG files of the profiles.
'options_store.mat': file, storing the options of the current experiment.
