...
**solar_matlab_load(**\ *problem_name*\ **)**
    **solar_matlab_load** converts a SOLAR problem name to a Problem class instance.

--------------------------------------------------------------------------

**problem** = **solar_matlab_load**\(**problem_name**) returns a **Problem**
...
You may use **solar_matlab_select** to get the problem names you want.
